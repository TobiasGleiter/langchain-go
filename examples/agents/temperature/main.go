...
func (t CurrentTemperatureInFahrenheit) Call(ctx context.Context, input string) (string, error) {
	return fmt.Sprintf("Current temperature: 87°F"), nil
}
...
func (t FormatFahrenheitToCelsius) Call(ctx context.Context, input string) (string, error) {
	...
	if err != nil {
		...
		return "", errors.New("I should use this tool again using the temperature in this format: XX°F and pass this information to the Action Input:\n")
	}
